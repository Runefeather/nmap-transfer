...
class struts_baseverify:
    ...
    def check(self, pocname, vulnstr):
        if vulnstr.find("Active Internet connections") is not -1:
            cprint("Target has" + pocname + "Vulnerability..[Linux]", "red")
            filecontent.writelines(pocname+" success!!!"+"\n")
        elif vulnstr.find("Active Connections") is not -1:
            cprint("Target has" + pocname + "Vulnerability..[Windows]", "red")
            filecontent.writelines(pocname+" success!!!"+"\n")
        elif vulnstr.find("Live connection") is not -1:
            cprint("Target has" + pocname + "Vulnerability..[Windows]", "red")
            filecontent.writelines(pocname+" success!!!"+"\n")
        elif vulnstr.find("LISTEN") is not -1:
            cprint("Target has" + pocname + "Vulnerability..[Unknow OS]", "red")
            filecontent.writelines(pocname+" success!!!"+"\n")
        else:
            cprint("Target does not have" + pocname +"Vulnerability..", "green")
...
|____/ \__|_|   \__,_|\__|___/    |____/ \___\__,_|_| |_|
                                        Code by Lucifer.
            ''', 'cyan')
        cprint("-------Checking struts2Vulnerability--------\nTarget url:"+self.url, "cyan")
        filecontent.writelines("Checking struts2Vulnerability: "+self.url)
        filecontent.write("\n")
        try:
            ...
            cprint("Checking struts2-005timeout..", "cyan")
        ...
        try:
            ...
            cprint("Checking struts2-008-1timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-008-2timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-009timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-013timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-016timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-019timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-devmodetimeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-032timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-033timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-037timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-045timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-046timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-048timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            if req1.status_code == 200 and req2.status_code == 404:
                cprint("Target hasstruts2-020Vulnerability..(只提供Checking )", "red")
                filecontent.writelines("struts2-020 success!!!\n")
            else:
                cprint("Target does not havestruts2-020Vulnerability..", "green")
        except Exception as e:
            cprint("Checking struts2-020timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            if req.status_code == 500 and r"java.security.Provider$Service" in req.text:
                cprint("Target hasstruts2-052Vulnerability..(参考metasploit中的struts2_rest_xstream模块)", "red")
                filecontent.writelines("struts2-052 success!!!\n")
            else:
                cprint("Target does not havestruts2-052Vulnerability..", "green")
        except Exception as e:
            cprint("Checking struts2-052timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            for param in params:
                ...
                tips = "Checking struts2-053 post参数: " + param
                cprint(tips)
                self.check("struts2-053", req.text)
        except Exception as e:
            cprint("Checking struts2-053timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-057-01timeout..", "cyan")
            print("Timeout reason: ", e)
        ...
        try:
            ...
            cprint("Checking struts2-057-2timeout..", "cyan")
            print("Timeout reason: ", e)
...
|____/ \__|_|   \__,_|\__|___/    |____/ \___\__,_|_| |_|
            ...
            while True:
                ...
                if command != "exit":
                    try:
                        ...
                        cprint("Command failed to run!!!", "red")
                else:
                    sys.exit(1)
        ...
        if pocname == "struts2-053":
            param = input("Please enter struts2-053 parameter: ")
            while True:
                print(prompt, end=' ')
                command = input()
                command = command.strip()
...
|____/ \__|_|   \__,_|\__|___/    |____/ \___\__,_|_| |_|
        ...
        '''
        cprint(figlet,'cyan')
        print("Usage: python struts-scan.py http://example.com/index.action  Checking ")
        print("       python struts-scan.py -u http://example.com/index.action -i struts2-045 enter selected Vulnerabilityinteractive shell")
        print("       python struts-scan.py -f url.txt  Batch Checking ")
